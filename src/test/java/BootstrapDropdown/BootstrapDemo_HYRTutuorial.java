...
/**
 * @author Yadagiri Reddy How to handle bootstrap dropdowns using Selenium
 *         WebDriver?
 */
public class BootstrapDemo_HYRTutuorial {
	...
	public static void main(String[] args) throws Exception {
		...
		// driver.findElements(By.xpath("//div[contains(@class,'dropdown-menu')]/a"));
		//
...
//   *******     Multi-selection bootstrap dropdown********
		...
		List<WebElement> options = driver.findElements(By.xpath(
				"//ul[contains(@class, 'multiselect-container')]/li[not(@class='multiselect-item multiselect-group')]/a/label"));
